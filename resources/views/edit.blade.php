...
<div class="container my-5">
    <h1 class="text-center mb-4 text-primary">Yangilikni Tahrirlash</h1>
        ...
        <div class="card-body">
            <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data" class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control border-success" id="title" name="title" value="{{$n->title}}" style="background-color: #eaffea;" required>
                </div>

                <!-- Content Field -->
                <div class="col-md-6">
                    <label for="content" class="form-label text-dark fw-bold">Mazmun</label>
                    <textarea class="form-control border-info" id="content" name="content" rows="3" style=" background-color: #e8f7ff;" required>{{$n->content}}</textarea>
                </div>
